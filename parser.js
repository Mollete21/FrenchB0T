...
const ACTION_COOLDOWN = 2*1000;
const FLOOD_MESSAGE_NUM = 4;
const FLOOD_PER_MSG_MIN = 400; // this is the minimum time between messages for legitimate spam. It's used to determine what "flooding" is caused by lag
const FLOOD_MESSAGE_TIME = 5*1000;
const MIN_CAPS_LENGTH = 8;
const MIN_CAPS_PROPORTION = 0.5;
